...
export const userText = "text-white block whitespace-nowrap m-2.5 text-sm box-border"

export const counter = "relative top-3%"
export const counterNumber = "rounded-full bg-purple-700 p-1 w-7 text-sm text-center"
