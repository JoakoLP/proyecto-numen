...
export const iconCont = "w-1/5 h-full flex justify-center items-center";
...
export const searchForm =
  "w-65% m-auto flex justify-between border border-white-0 rounded-lg py-5px px-7px bg-neutral-800 items-center";
export const searchTxt =
  " text-slate-300 w-full bg-neutral-800 h-full border-none outline-0 text-sm placeholder:text-purple-500 placeholder:opacity-40";
